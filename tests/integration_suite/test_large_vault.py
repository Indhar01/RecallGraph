...
class TestSmallVaultPerformance:
    ...
    @pytest.mark.asyncio
    async def test_sync_10_files_performance(
    ...
    @pytest.mark.asyncio
    async def test_sync_50_files_performance(
        self, sync_engine, performance_vault
    ):
...
class TestMediumVaultPerformance:
    ...
    @pytest.mark.asyncio
    async def test_sync_100_files_performance(
        self, sync_engine, performance_vault
    ):
    ...
    @pytest.mark.asyncio
    async def test_batch_sync_optimization(
        self, sync_engine, performance_vault
    ):
        ...
        batch_stats = await sync_engine.batch_sync(
            direction="pull",
            batch_size=20
        )
...
class TestLargeVaultPerformance:
    ...
    async def test_sync_1000_files_performance(
        self, sync_engine, performance_vault
    ):
...
class TestMemoryEfficiency:
    ...
    @pytest.mark.asyncio
    async def test_graph_memory_efficiency(
        self, sync_engine, performance_vault
    ):
...
class TestScalingLimits:
    ...
    @pytest.mark.asyncio
    @pytest.mark.slow
    async def test_max_practical_vault_size(
        self, sync_engine, performance_vault
    ):
    ...
    async def test_deeply_nested_structure_performance(
        ...
        assert stats["pulled"] == 100
        assert sync_time < 30.0  # Deep nesting shouldn't significantly impact performance
...
class TestPerformanceRegression:
    ...
    @pytest.mark.asyncio
    async def test_baseline_performance_100_files(
        self, sync_engine, performance_vault
    ):
