...
class TestListCommandTagFiltering:
    ...
    def test_list_with_single_tag(self, kernel_with_tagged_memories: MemoryKernel, capsys):
    ...
    def test_list_with_multiple_tags(self, kernel_with_tagged_memories: MemoryKernel, capsys):
    ...
    def test_list_with_nonexistent_tag(self, kernel_with_tagged_memories: MemoryKernel, capsys):
...
class TestUpdateCommandTagFiltering:
    ...
    def test_update_with_multiple_tag_filter(self, kernel_with_tagged_memories: MemoryKernel):
...
class TestDeleteCommandTagFiltering:
    ...
    def test_delete_with_tag_filter_dry_run(self, kernel_with_tagged_memories: MemoryKernel, capsys):
...
class TestFindMemoriesByFilter:
    ...
    def test_find_by_multiple_tags_any_match(self, kernel_with_tagged_memories: MemoryKernel):
        """Test finding memories with any of multiple tags."""
        vault_path = Path(kernel_with_tagged_memories.vault_path)
        
        memories = find_memories_by_filter(vault_path, tags=["python", "javascript"])
        assert len(memories) >= 3  # At least Python Tutorial, Python Advanced, JavaScript Guide
    ...
    def test_find_by_tag_and_salience_range(self, kernel_with_tagged_memories: MemoryKernel):
