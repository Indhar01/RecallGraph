...
class TestDeleteSafety:
    ...
    def test_bulk_confirmation_shows_count(self, test_vault_with_memories, capsys, monkeypatch):
        ...
        output = capsys.readouterr().out
        assert "Found 2 matching memories" in output  # Should show count in confirmation
